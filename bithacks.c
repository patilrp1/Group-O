...
void test_B_MASKIDENT_0()
{
    unsigned char x;

	x = B8(01011000);
    TEST_OK(B_MASKIDENT_0(x), B8(00000111));
    TEST_OK(B_MASKIDENT_0(x), B8(00000000));

    x = B8(10100000);
    TEST_OK(B_MASKIDENT_0(x), B8(00011111));
    TEST_OK(B_MASKIDENT_0(x), B8(00000000));

    x = B8(00110000);
    TEST_OK(B_MASKIDENT_0(x), B8(00001111));
    TEST_OK(B_MASKIDENT_0(x), B8(00000000));
}

void test_B_COMPLEMENT2_0()
{
    unsigned char x;

    x = B8(01011000);
    TEST_OK(B_COMPLEMENT2_0(x), B8(10101000));

    x = B8(10100000);
    TEST_OK(B_COMPLEMENT2_0(x), B8(01100000));

    x = B8(00110000);
    TEST_OK(B_COMPLEMENT2_0(x), B8(11010000));
}
